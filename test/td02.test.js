...
describe('exercice 2', () => {
  ...
  describe('exercice 2.1', () => {
    test('img', () => {
      expect(img).to.be.a('function')
      expect(img('http://example.com/img.jpg')).to.deep.eq({
        name: 'img',
  ...
  test('exercice 2.2', () => {
    ...
    expect(dogMarkup.children[1].children[0].children).to.eq(['doggo'])
    expect(dogMarkup.children[1].children[1].name).to.eq('p')
    expect(dogMarkup.children[1].children[1].children).to.eq(['pretty puppy'])
  })
